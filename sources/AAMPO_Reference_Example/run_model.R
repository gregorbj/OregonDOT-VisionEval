...
for(Year in getYears()) {
  ...
  runModule("CalculateCarbonIntensity",        "VEPowertrainsAndFuelsxAPx20180302x20181213", RunFor = "AllYears",    RunYear = Year)
  runModule("AssignHhVehiclePowertrain",       "VEPowertrainsAndFuelsxAPx20180302x20181213", RunFor = "AllYears",    RunYear = Year)
  for (i in 1:2) {
...
#Produce region summaries
#------------------------
calcRegionSummaryMeasures(
  MeasuresDefFile = "defs/region_measures_def.json",
  Years_ = c("2010", "2040"),
  WriteTable = "region_summary_measures.csv"
)
